...
public class Test {
	...
	public static void main(String[] args) {
		...
		persons.add(0, new Employee("Sarkozy","Nicolas",66,"Paris", paris,"CAC-40" ,2204.0));
		persons.add(0, new Employee("N'doure","Youssou",62,"Ngor", dakar,"Gouvernement Mbaye", 240000.0));
		persons.add(0, new Employee("Depardieu","Gerard",72,"Moscou", new City("Châteauxroux","France"),"Cote du Rhone", 85000.0));
		persons.add(0, new Employee("Gate","Bill",65,"USA", new City("Washington","USA"),"Fondation B&M", 100000.0));
		persons.add(0, new Employee("Musk","Elon",49,"pao alto", new City("Pretoria","Afrique du Sud", 800000),"Fondation B&M", 150000.0));
		persons.add(0, new Commercial("Dupon","Robert",50,"rue des rosier Toulouse", new City("Limoge","France"),"Brico", 5.0));
		persons.add(0, new Commercial("Bruce","Wayne",40,"Ghottam", new City("Ghottam","USA"), "Justice Society of America" , 50.0));
		persons.add(0, new Commercial("Macron","Emmanuel",43,"Elysee à Paris", new City("Amiens","France", 100), "MEDEF" , 0.5));
		for(Person P : persons) System.out.println(P +""+ P.remuneration());
